# -*- coding: utf-8 -*-
# Generated by Django 1.11.20 on 2019-05-20 09:58
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('change_type', models.SmallIntegerField(choices=[(1, b'add user to group'), (2, b'remove user from group')])),
                ...
                ('initiator', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='historygenericusertogroup_initiator', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reason', models.TextField(validators=[django.core.validators.MinLengthValidator(1)], verbose_name='change reason')),
                ('changed_at', models.DateTimeField(auto_now_add=True, verbose_name='change date')),
                ('change_type', models.SmallIntegerField(choices=[(1, b'add permission'), (2, b'remove permission')])),
                ...
                ('initiator', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='historyownertopermission_initiator', to=settings.AUTH_USER_MODEL)),
